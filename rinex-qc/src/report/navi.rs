...
impl QcNavi {
    pub fn new(context: &QcContext) -> Self {
        let mut pages = HashMap::<Constellation, ConstellationPlot>::new();
        ...
        for constell in observation.constellation() {
            ...
            pages.insert(constell, ConstellationPlot::new(&focused, context));
        }
        Self { pages }
    }
}
