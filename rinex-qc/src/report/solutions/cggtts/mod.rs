use crate::prelude::{html, Markup, Plot, QcContext, Render};
...
#[derive(Default)]
pub struct QcNavPostCggttsSolutions {
    summary: Summary,
    // sv_plot: Plot,
    // elev_plot: Plot,
    // sky_plot: Plot,
...
impl QcNavPostCggttsSolutions {
    pub fn new_track(&mut self, track: &Track) {
        self.summary.new_track(track);
    }
    // sv_plot: {
...
impl Render for QcNavPostCggttsSolutions {
