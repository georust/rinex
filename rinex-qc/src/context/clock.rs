...
pub struct ClockContext {
    identified: HashMap<ClockDataIdentifier, Rinex>,
    unidentified: HashMap<MetaData, Rinex>,
}

impl ClockContext {
    /// Loads a new [Rinex] into this [ClockContext]
