...
use rtk::prelude::{
    model::TropoComponents, Candidate, Config, Epoch, Estimate, InterpolationResult, Mode, Solver,
};
use thiserror::Error;
...
pub fn solver(ctx: &mut RnxContext) -> Result<HashMap<Epoch, Estimate>, Error> {
    ...
    let ecef = apriori.to_ecef_wgs84();
