...
/// Observation RINEX specific header fields
...
impl HeaderFields {
    ...
    /// Returns scaling to apply for this GNSS system.
    /// Returns 1.0 by default: so it may always apply.
