...
lazy_static! {
    pub(crate) static ref KNOWN_CODES: Vec<&'static str> = vec![
        "1A", "1B", "1C", "1D", "1E", "1L", "1M", "1P", "1S", "1W", "1X", "1Z", "2C", "2D", "2L", "2M",
        "2P", "2S", "2W", "3I", "3X", "3Q", "4A", "4B", "4X", "5A", "5B", "5C", "5D", "5I", "5P", "5Q",
        "5X", "6A", "6B", "6C", "6D", "6E", "6I", "6P", "6Q", "6X", "6Z", "7D", "7I", "7P", "7Q", "7X", "7Z", "8D", "8P", "8I",
        "8Q", "8X", "9A", "9B", "9C", "9X",
    ];
}
...
impl Carrier {
    ...
    pub fn bandwidth_mhz(&self) -> f64 {
        match self {
            ...
            Self::B2  | Self::B2A | Self::B2I | Self::B2B => todo!("B2X bandwidth is not known to this day"),
    ...
    pub fn from_observable(constellation: Constellation, observable: &Observable) -> Result<Self, Error> {
        match constellation {
